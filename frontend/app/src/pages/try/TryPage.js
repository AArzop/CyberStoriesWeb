...
class TryPage extends Component {
  render () {
    return (
      <div>
        <NavigationBar/>
        <div className="container" style={{margin: 'auto', marginTop:50}}>
          <div className="webgl-content" style={{margin:'auto'}}>
            <div id="unityContainer" style={{ width: '950px', height: '550px', margin:'auto !important' }}></div>
          </div>
